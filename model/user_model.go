...
type User struct {
	...
	NickName     string    `gorm:"type:varchar(50);not null"`  //用户昵称
	...
	AlipayID     string    `gorm:"type:varchar(50)"`           //支付宝用户ID
	WeChatID     string    `gorm:"type:varchar(50)"`           //微信用户ID
	IsThirdParty bool      `gorm:"not null"`                   //是否是第三方登录的用户
}
